...
A mono overdrive effect written in Rust.
...
You can download the VST3 and CLAP plugins for Linux, Windows and macOS from the [release page](https://github.com/davemollen/dm-TubeScreamer/releases).
